...
def extract_conflicts_csv(country, start_date, end_date):
    ...
    conflict_df.to_csv(os.path.join(current_dir, country, "conflicts.csv"), index=False)

    # Print a completion message
    print(f'{country}/conflicts.csv created. Please inspect the file for unwanted anomalies!')
...
extract_conflicts_csv(country, start_date, end_date)

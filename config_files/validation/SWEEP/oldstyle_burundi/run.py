...
"""
Old-style Burundi simulation, still with hard-coded location graph and conflicts.
"""
...
if __name__ == "__main__":
  ...
  d = handle_refugee_data.RefugeeTable(csvformat="generic", data_directory="source_data", start_date="2015-05-01")
